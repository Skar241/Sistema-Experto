...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecciona una opción", "Bajar de peso", "Ponerte en froma", "Aumentar masa" }));
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        ...
        try {
            ...
            if(validar()){
                ...
                writer.add("meta",Integer.toString(jComboBox2.getSelectedIndex()));
...
//>>>>>>> 62e645f352d2758b66f8aec5c0f10f0eaa401d81
    ...
    private boolean validar(){
        if (jTextPane1.getText().isEmpty())
            ...
            JOptionPane.showMessageDialog(null,"Ingresa tu meta");
